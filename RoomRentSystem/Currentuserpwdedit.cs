...
namespace RoomRentSystem
{
    public partial class Currentuserpwdedit : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            //
            string oldpwd="", newpwd="", sqltext, sqltext1, username="";
            int flag;
            DataSet ds = new DataSet();

            sqltext = "select password from t_user where user='" + username + "'";
            sqltext1 = "update t_user set password='" + newpwd + "' where user='" + username + "'";
